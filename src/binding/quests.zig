...
pub export fn impl_SendJournalChanges(
    pid: c_ushort,
    ...
    return @call(
        .never_inline,
        zigSendJournalChanges,
        .{ pid, sendToOtherPlayers, skipAttachedPlayer },
    );
}
pub export fn impl_GetJournalItemQuest(pid: c_ushort, index: c_uint) callconv(.C) c_str {
...
pub export fn impl_GetJournalItemActorRefId(pid: c_ushort, index: c_uint) callconv(.C) c_str {
    return @call(.never_inline, zigGetJournalItemActorRefId, .{ pid, index });
}
pub export fn impl_AddJournalEntry(
    pid: c_ushort,
    quest: c_str,
    index: c_uint,
    actorRefId: c_str,
...
pub export fn impl_AddJournalEntryWithTimestamp(
    pid: c_ushort,
    quest: c_str,
    index: c_uint,
    actorRefId: c_str,
    ...
    return @call(
        .never_inline,
        zigAddJournalEntryWithTimestamp,
        .{ pid, quest, index, actorRefId, daysPassed, month, day },
    );
}
pub export fn impl_AddJournalIndex(pid: c_ushort, quest: c_str, index: c_uint) callconv(.C) void {
...
pub export fn impl_SetReputation(pid: c_ushort, reputation: c_int) callconv(.C) void {
    return @call(.never_inline, zigSetReputation, .{ pid, reputation });
}
pub export fn impl_SendReputation(
    pid: c_ushort,
    sendToOtherPlayers: bool,
    skipAttachedPlayer: bool,
) callconv(.C) void {
