...
pub const actor = @import("binding/actors.zig");
pub const book = @import("binding/books.zig");
pub const cell = @import("binding/cells.zig");
...
pub const faction = @import("binding/factions.zig");
pub const gui = @import("binding/gui.zig");
pub const item = @import("binding/items.zig");
pub const mechanic = @import("binding/mechanics.zig");
pub const miscellaneous = @import("binding/miscellaneous.zig");
pub const object = @import("binding/objects.zig");
pub const position = @import("binding/positions.zig");
pub const quest = @import("binding/quests.zig");
pub const records_dynamic = @import("binding/records_dynamic.zig");
pub const server = @import("binding/server.zig");
pub const setting = @import("binding/settings.zig");
pub const shapeshift = @import("binding/shapeshift.zig");
pub const spell = @import("binding/spells.zig");
pub const stat = @import("binding/stats.zig");
